                                    ...
                                    <tr data-id="{{ $id }}" data-variant="{{ $variantId }}">
                                        ...
                                        <td data-th="Quantity">
                                            <input type="number" value="{{ $subVariant['quantity'] }}"
                                                class="form-control quantity update-cart" max="{{getProductAvailabityStock($details['product_id'])}}"/>
                                        </td>
                                        <td data-th="discount">
                                            {{ $subVariant['discount_price'] ? $subVariant['discount_price'] : 0 }}</td>
                                        <td data-th="SubTotal">
                        ...
                        @else
                            ...
                            <tr data-id="{{ $id }}" data-variant="">
                                <td data-th="Product">
                                    <div class="row">
                                        <div class="col-sm-3 hidden-xs">
                                            <img src="{{ asset('frontend/img/product/details/product-details-1.jpg') }}"
                                                width="100" height="100" class="img-responsive" />
                                        </div>
                                        <div class="col-sm-9">
                                            <h4 class="nomargin">{{ $details['name'] }}</h4>
