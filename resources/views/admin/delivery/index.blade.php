                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="w-1/2 p-2">
                            ...
                            <input :value="old('tracking_number')" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500""
                    ...
                    <div class="flex flex-wrap -m-2">
                        <div class="w-1/2 p-2">
                            ...
                            <input :value="old('recipient')" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500""
                                type=" text" name="recipient" wire:model="recipient">
                            @error('recipient') <span class="text-red-550">{{ $message }}</span>@enderror
                        </div>
                        <div class="w-1/2 p-2">
                            <label for="price">{{ __('Price') }}* </label>
                            <input :value="old('price')" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500""
                    ...
                    <div class="form-group">
                        ...
                        <input :value="old('address')" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500""
                    ...
                    <div class="flex flex-wrap -m-2">
                        <div class="w-1/3 p-2">
                            ...
                            <input :value="old('expected_arrival')" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500""
                        ...
                        <div class="w-1/3 p-2">
                            ...
                            <input :value="old('actual_arrival')" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500""
                    ...
                    <div class="form-group">
                        ...
                        <textarea :value="old('description')" class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-purple-500""
                    ...
                    <div class="form-group">
                        <button class="bg-green-500 hover:bg-green-700 text-white font-bold my-5 py-2 w-full rounded">{{ __('Submit') }}</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border inline-flex px-3 py-3">
                            ...
                            <button type="button" wire:click="deleteId({{ $delivery->id }})" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">{{ __('Delete') }}</button>
                            {{-- @endcan --}}
                        </td>
                        @endforeach
                    </tr>
