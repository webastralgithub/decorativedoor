                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle ">
                                ...
                                !auth()
                                ->user()
                                ->can(['order-status-pending-order-confirmation', 'order-status-complete',
                                'order-status-failed', 'order-status-dispatch']) &&
                                in_array($item->order_status, [\App\Models\OrderStatus::COMPLETE,
                                \App\Models\OrderStatus::PENDING_ORDER_CONFIRMATION, \App\Models\OrderStatus::FAILED,
                                \App\Models\OrderStatus::DISPATCHED])) ||
                                (auth()
                                ->user()
                                ...
                                ->user()
                                ->can(['order-status-pending-order-confirmation', 'order-status-complete',
                                'order-status-failed', 'order-status-ready-to-production']) &&
                                in_array($item->order_status, [\App\Models\OrderStatus::COMPLETE,
                                \App\Models\OrderStatus::PENDING_ORDER_CONFIRMATION, \App\Models\OrderStatus::FAILED,
                                \App\Models\OrderStatus::READY_TO_PRODUCTION])) ||
                                (auth()
                                ->user()
                                ->hasRole('Accountant') &&
                                !auth()
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 row delivery-products">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-md-12" style="line-height: 35px;">
                                                <input type="number" name="delivery_quantity" id="d-delivery_quantity"
                                                    class="form-control example-date-input"
                                                    value="{{ old('delivery_quantity') }}" required min="0">
                                                @error('delivery_quantity')
                                                <span class="text-danger">{{ $message }}</span>
