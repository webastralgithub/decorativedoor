                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3 row delivery-products">
                                        ...
                                        <input type="hidden" name="orders_quantity" id="orders_quantity"
                                            value="">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="note"
                                                    class="col-md-12 col-form-label text-md-end text-start">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="note"
                                                    class="col-md-12 col-form-label text-md-end text-start">
                                                    {{ __('Production Ready Quantity :') }} <span
                                                        id="delivery_order">0</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-6">
                                            <input type="button" class="btn btn-primary btn-sm"
                                                onclick="return updateOrderItemQuantity();" name="submit"
                                                value="Submit">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3 row delivery-products">
                                        ...
                                        <input type="hidden" name="order_id" id="d-order_id"
                                            value="{{ $order->id }}">
                                        <input type="hidden" name="new_status" id="d-new_status" value="">
                                        <input type="hidden" name="orders_quantity" id="d-orders_quantity"
                                            value="">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="note"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="note"
                                                    class="col-md-12 col-form-label text-md-end text-start">
                                                    {{ __('Deliverd Quantity :') }} <span
                                                        id="d-deliverd_quantity">0</span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12" style="line-height: 35px;">
                                                    <input type="number" name="delivery_quantity"
                                                        id="d-delivery_quantity" class="form-control example-date-input"
                                                        value="{{ old('delivery_quantity') }}" required min="0">
                                                    @error('delivery_quantity')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                ...
                                <div class="modal-footer delivery-products-footer">
                                    <div class="row">
                                        <div class="col-md-12 mt-6">
                                            <input type="button" class="btn btn-primary btn-sm"
                                                onclick="return deleiveryupdateOrderItemQuantity();" name="submit"
                                                value="Submit">
                                        </div>
                                    </div>
                                </div>
