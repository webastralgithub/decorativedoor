                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i>
                                        <span class="fw-bold">Creation Date: </span>{{ $order->order_date->format('M d,
                                        Y') }}
                                    </li>
                                    <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i>
                        ...
                        <div class="row my-2 additinal-notes-print-tottle">
                            ...
                            <div class="col-xl-3">
                                <ul class="list-unstyled list-totle-sub-totle-print">
                                    ...
                                    <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Tax </span>${{
                                        number_format($order->vat, 2, '.', ',') }}</li>
                                </ul>
                                <p class="text-black float-start total-price-print"><span class="text-black me-3"> Total
                                        Amount</span><span style="font-size: 25px;">${{ (number_format($order->total -
                                        $order->vat, 2, '.', ',')) }}</span></p>
                            </div>
                        </div>
