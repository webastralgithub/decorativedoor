...
<div class="mx-4 content-p-mobile">
    ...
    <div class="content-body">
        ...
        <div class="mb-3 row">
            <div class="col-md-4"><strong> Total Amount : ${{ number_format(getOrderTotalprice($order->id), 2, '.', ',') }} </strong></div>
            <div class="col-md-4"><strong> Recived Amount : ${{ $totalpending }} </strong></div>
            <div class="col-md-4"><strong> Pending Amount : ${{ number_format((getOrderTotalprice($order->id) - $totalpending), 2, '.', ',')}} </strong></div>
        </div>
