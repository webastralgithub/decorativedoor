...
<head>
	...
	<style>
		* {
		...
		.product-wrapper .product-wrapper-right p,
		.product-wrapper .product-wrapper-right p span {
			text-align: left;
			color: #fff !important;
		}
...
<body style="background-color: #cedae6; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
		style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #cedae6; background-image: none; background-position: top left; background-size: auto; background-repeat: no-repeat;"
		width="100%">
		<tbody>
			<tr>
				<td>
						...
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e4f2ff; color: #000000; width: 640px; margin: 0 auto;"
										width="640">
										<tbody>
											<tr>
												<td class="column column-1"
															...
															<td class="pad">
																<div class="product-wrapper">
																	...
																	<div class="product-wrapper-right">
																		<div
																			style="color:#2b2d49;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:30px;line-height:150%;text-align:center;mso-line-height-alt:45px;">
																			<p
																				style="margin: 0; word-break: break-word;">
																				<span
																					style="caret-color:#152a6d;"><strong>{{ $emailData['title'] }}</strong></span></p>
																			<p
																				style="margin: 0; word-break: break-word;">
																				<span style="color:#152a6d;"><span
																						style="caret-color:#152a6d;"><span
																							style="color:#a31731;"><strong><span
																									style="color:#a31731;"></span>
                                                                                                    {{ $emailData['price'] }}</strong></span></span></span>
																			</p>
																		</div>
																		<div
																			style="color:#2b2d49;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
																			<p
																				style="margin: 0; word-break: break-word;">
																				<span
																					style="font-size:13px; #2b2d49;">{!! $emailData['description'] !!}</span></p>
																		</div>
																	</div>
																</div>
														...
														<tr>
															<td class="pad">
                                                                ...
                                                                <table style="width:100%">
                                                                    ...
                                                                    @if(count($emailData['variants']) > 0)
                                                                    <tr>
                                                                        <td rowspan="{{ count($emailData['variants']) }}">{{ $emailData['title'] }}</td>
                                                                        <td>{{ $emailData['variants'][0]->name }}</td>
                                                                        <td>{{ $emailData['variants'][0]->selling_price }}</td>
                                                                    </tr>
                                                                
                                                                    @for($i = 1; $i < count($emailData['variants']); $i++) <tr>
                                                                        <td>{{ $emailData['variants'][$i]->name }}</td>
                                                                        <td>{{ $emailData['variants'][$i]->selling_price }}</td>
                                                                        </tr>
                                                                        @endfor
                                                                        @endif
                                                                </table>
														...
														@if(count($emailData['images']) > 1)
															<td class="pad">
																<div
																	...
																	<p
																		style="margin: 0; word-break: break-word; font-size: 20px;">
																		<span style="caret-color:#152a6d;"><strong>Also
								...
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										...
										<tbody>
											<tr>
												<td class="column column-1"
													style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;font-weight: 400;text-align: left;padding-bottom: 5px;padding-top: 0px;vertical-align: top;border-top: 0px;border-right: 0px;border-bottom: 0px;border-left: 0px;"
													width="100%">
												...
												<td class="column column-1"
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#4a4a4a;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
																	<p style="margin: 0; word-break: break-word;">Your
																		Street 12, 34567 AB City</p>
																	<p style="margin: 0; word-break: break-word;">
																		info@example.com</p>
																	<p style="margin: 0; word-break: break-word;">(+1)
																		123 456 789</p>
																</div>
															</td>
														</tr>
